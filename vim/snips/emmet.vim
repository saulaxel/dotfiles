...
\      '^\%(lorem-ja\|lipsum-ja\)\(\d*\)$' : function('emmet#lorem#ja#expand'),
\    },
\    'css': {
\        'snippets': {
\           "@i": "@import url(|);",
...
\           "bg": "background:|;",
\           "bgbl": "background:#${1:111};",
\           "bgwt": "background:#${1:000};",
...
\           "lp": "background-image: url(http://lorempixel/|/);"
\        },
\        'filters': 'fc',
\    },
\    'sass': {
...
\                    ."<body>\n\t${child}|\n</body>\n"
\                    ."</html>",
\                'lp':"<img src=\"http://lorempixel.com/|/\" alt=\"|\" \/>",
\        },
\        'default_attributes': {
\            'a': [{'href': ''}],
\            'a:link': [{'href': 'http://|'}],
